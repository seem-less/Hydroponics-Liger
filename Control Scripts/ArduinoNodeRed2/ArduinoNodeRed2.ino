...
int floatPin = 5;      // the number of the input pin
...
void setup()
{
  ...
  //setting pinmode for the foat switch
...
//    Serial.print(ECoutputValue);
    String ECVal = (String)ECoutputValue;                   //serial value for EC output value
...
//    Serial.print("\t");       // Print tab space
    String tempVal = (String)sensors.getTempCByIndex(0);
...
//    Serial.println("mL");
    ...
    //FLOAT SWITCH LOOP CODE
    reading = digitalRead(floatPin);
